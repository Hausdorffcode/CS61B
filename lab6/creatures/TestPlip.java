...
public class TestPlip {
    ...
    public void testReplicate() {
        Plip pp = new Plip(2);
        Plip ps = pp.replicate();
        assertNotSame(pp, ps);
        assertEquals(1.0, pp.energy(), 0.01);
        assertEquals(1.0, ps.energy(), 0.01);
    }
    ...
    public void testChoose() {
        ...
        HashMap<Direction, Occupant> notsurrounded = new HashMap<>();
        ...
        notsurrounded.put(Direction.TOP, new Empty());

        Action actual2 = p.chooseAction(notsurrounded);
